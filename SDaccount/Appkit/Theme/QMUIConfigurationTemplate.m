...
+ (void)setupConfigurationTemplate {
    ...
    QMUICMI.navBarButtonFontBold = nil;                                         // NavBarButtonFontBold : QMUINavigationButtonTypeBold 的字体
        QMUICMI.navBarBackgroundImage = [UIImage imageWithColor:UIColorMakeWithHex(SD_THEME_COLOR)];                                        // NavBarBackgroundImage : UINavigationBar 的背景图
    QMUICMI.navBarShadowImage = [UIImage imageWithColor:UIColorMakeWithHex(SD_THEME_COLOR)];                                            // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线
    ...
    QMUICMI.tabBarTintColor = UIColorMakeWithHex(SD_THEME_COLOR);                                              // TabBarTintColor : UITabBar 的 tintColor
